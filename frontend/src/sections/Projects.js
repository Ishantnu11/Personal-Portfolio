...
const PROJECTS = [
  {
    ...
    github: 'https://github.com/Ishantnu11/RAG-BASED-AI-TEACHING-ASSISTANT-',
  },
  {
    id: 2,
    ...
    github: 'https://github.com/Ishantnu11/E-Commerce-Sales-Performance-Customer-Segmentation-Capstone-Project-',
  },
  {
    id: 3,
    ...
    github: 'https://github.com/Ishantnu11/Gurgaon-Housing-Price-Predictor',
  },
  {
    id: 4,
    ...
    github: 'https://github.com/Ishantnu11/Ola-Monthly-Report',
  },
  {
    id: 5,
    ...
    color: '#8338ec',
    emoji: '🔍',
    description: 'Advanced market research platform using LangGraph and Gemini 2.5 Flash for deep web research, competitor SWOT analysis, and executive-level Markdown reports with real-time SSE streaming.',
    highlights: [
      'Parallel Research: Concurrent Tavily searches reduce wait times by 50%',
      'HITL Checkpoint: User approves competitors before analysis',
      'SWOT Analysis: Cross-referencing and trend generation',
      'Thread-Safe SSE: Real-time event streaming with optimized background threads',
      'Advanced LLM: Gemini 2.5 Flash for superior reasoning and depth',
    ],
    stack: ['LangGraph', 'Gemini 2.5 Flash', 'Tavily', 'FastAPI', 'React', 'Vite', 'Groq'],
    github: 'https://github.com/Ishantnu11/market-research',
  },
  {
    id: 6,
    title: 'Synthetix AI: 3D Interview Simulator',
    tag: 'AI / 3D UI',
    type: 'FEATURED',
    color: '#ffbe0b',
    emoji: '🎭',
    description: 'Immersive 3D interview simulator using multi-agent LLM architecture with React Three Fiber for premium UX, real-time streaming, and comprehensive performance evaluation.',
    highlights: [
      'Multi-Agent Architecture: Interviewer and Evaluator LLM personas',
      '3D Immersive UI: Built with React Three Fiber and Drei',
      'Real-Time Streaming: Mimics live chat with context-aware responses',
      'Detailed Evaluation: Executive summary, strengths, improvements, scoring',
      'Contextual State Management: Remembers conversation for follow-ups',
    ],
    stack: ['React', 'React Three Fiber', 'FastAPI', 'Gemini 2.0 Flash', 'CSS Modules', 'Lucide Icons'],
    github: 'https://github.com/Ishantnu11/AI-interview-Assistant',
  },
  {
    id: 7,
    title: 'SentinelRAG: Observability Pipeline',
    tag: 'AI / RAG',
    type: 'FEATURED',
    color: '#fb5607',
    emoji: '🛡️',
    description: 'Production-grade RAG system with extreme observability using LangGraph, ChromaDB, and Arize Phoenix for real-time metrics, node-level tracing, and automated CI/CD gating.',
    highlights: [
      'Agentic Self-Correction: LLM grader ensures document relevance',
      'Zero-Cost Web Fallback: DuckDuckGo Search + Scrapling extraction',
      'Full Observability: Arize Phoenix for deep tracing',
      'Automated Evaluation: RAGAS CI/CD gating with faithfulness checks',
      'Local-First Architecture: 100% privacy-focused, no data leaves environment',
    ],
    stack: ['LangGraph', 'ChromaDB', 'Ollama', 'Scrapling', 'Arize Phoenix', 'RAGAS', 'DuckDuckGo'],
    github: 'https://github.com/Ishantnu11/RAG-Ops-Sentinel',
  },
];
